...
from genomicinfo.entity_extraction.ner.nala.data import Entity, Relation
                ...
                for e in ann_json['entities']:
                    ...
                    if self.read_only_class_id is None or e['classId'] in self.read_only_class_id:
                        ...
                        try:
                            ...
                            print("The normalization is badly formatted: (docid={}) {}".format(doc_id, str(e['normalizations'])))
                            normalizations = None
