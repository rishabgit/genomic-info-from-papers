...
import random
import re
from genomicinfo.entity_extraction.ner.nala.qmath import arithmetic_mean
import warnings
...
class Document:
    ...
    def overlaps_with_mention(self, *span, annotated=True):
        ...
        for pid, part in self.parts.items():
            print("Part {0}: {1}".format(pid, part))
            if annotated:
            ...
            for ann in annotations:
                ...
                print("CURRENT:".ljust(10) + ann.text.rjust(ann.offset + len(ann.text), 'o') + 'o' * (
