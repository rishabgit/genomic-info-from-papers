...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(eval_dataloader):
            ...
            for row in preds: temp_preds.append(row)
            for row in refs: temp_refs.append(row)

        # evaluator = Evaluator(temp_refs, temp_preds, tags=['DNA', 'Mut', 'RNA', 'dbS', 'loc'], loader="list")
        evaluator = Evaluator(temp_refs, temp_preds, tags=[''], loader="list")
